...
try:
    ...
    with open(csv_filename, mode='w', newline='', encoding='utf-8') as file:
        ...
        writer.writerow(['Username', 'Posted At', 'Post Content', 'Image URL', 'Video URL', 'Tag'])
            ...
            for tweet in tweets:
                try:
                    ...
                    if tweet_id not in unique_tweets:
                        ...
                        # Write data to CSV with "Palestine" tag in the "Tag" column
                        writer.writerow(['OnlinePalEng', timestamp, content, ', '.join(image_urls), ', '.join(video_urls), 'Palestine'])
